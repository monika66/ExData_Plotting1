...
## The R script 'plot3.R' reads electric power consumption data from 
## the UC Irvine Machine Learning Repository and plots the 
## Energy sub metering for the first and second february 2007 
## on screen device and file 'plot3.png'.
